...
public class TowerDefGrid : MonoBehaviour
{
	...
	public GameObject infoPlayerTurn;
	public GameObject infoEnemyTurn;
    ...
    void NewRound()
    {
		...
		infoEnemyTurn.SetActive(false);
		infoPlayerTurn.SetActive(true);
		UI.GetComponent<UIControl>().InfoText();
    ...
    void WaitRound()
    {
		infoPlayerTurn.SetActive(false);
		infoEnemyTurn.SetActive(true);
		UI.GetComponent<UIControl>().InfoText();
    ...
    void MoveEnemy()
    {
        ...
        foreach (GameObject Enemy in Enemies)
        {
			...
			Enemy.GetComponent<Enemy>().ClearInfo();
